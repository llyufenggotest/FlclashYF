...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "dropExactlyOneProfile": MessageLookupByLibrary.simpleMessage("请拖放一个配置文件"),
    "droppedItemNotFile": MessageLookupByLibrary.simpleMessage("拖放的项目不是文件"),
    ...
    "fileImport": MessageLookupByLibrary.simpleMessage("文件导入"),
    ...
    "profileFileTooLarge": MessageLookupByLibrary.simpleMessage("配置文件过大"),
    ...
    "profileTemplate": MessageLookupByLibrary.simpleMessage("配置文件模板"),
    ...
    "profileTemplateSaved": MessageLookupByLibrary.simpleMessage("配置文件模板已保存"),
    "profileTemplateYaml": MessageLookupByLibrary.simpleMessage("模板 YAML"),
    ...
    "routeInvalidInput": MessageLookupByLibrary.simpleMessage(
      "请输入有效的域名、IP、CIDR 或 HTTP(S) URL",
    ),
    "routeMembers": MessageLookupByLibrary.simpleMessage("节点和组"),
    ...
    "routeNoProfile": MessageLookupByLibrary.simpleMessage("选择一个配置以设置路由"),
    "routeProviders": MessageLookupByLibrary.simpleMessage("规则提供者"),
    "routeRules": MessageLookupByLibrary.simpleMessage("路由规则"),
    "routeTarget": MessageLookupByLibrary.simpleMessage("目标"),
