    ...
    try {
          ...
          onEditTemplate: () async {
            await navigator.push(
              MaterialPageRoute<void>(
                builder: (_) => const ProfileTemplateView(),
              ),
            );
          },
        ),
      ...
      await showDialog<void>(
        ...
        builder: (dialogContext) => AlertDialog(
          title: Text(appLocalizations.fileImport),
